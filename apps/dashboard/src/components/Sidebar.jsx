...
import { useDedupCount } from '../hooks/useDedupQueue.js'
...
export default function Sidebar() {
  ...
  const { count: dedupCount } = useDedupCount()
  ...
  return (
    <aside className={'app-sidebar' + (sidebarCollapsed ? ' collapsed' : '')}>
      ...
      <div className="sidebar-nav">
        ...
        {/* CRM Attio-style — grupo em purple */}
        <SidebarGroup id="crm" label="CRM" accent="var(--purple)">
          ...
          <NavItem to="/crm/dedup"         label="Dedup queue"   icon={GitMerge}     badge={dedupCount} />
        </SidebarGroup>
